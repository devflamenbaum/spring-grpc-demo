...
public final class GreetingServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.devflamenbaum.grpc.api.GreetingService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.devflamenbaum.grpc.api.GreetingRequest,
      com.devflamenbaum.grpc.api.GreetingResponse> getGreetingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "greeting",
      requestType = com.devflamenbaum.grpc.api.GreetingRequest.class,
      responseType = com.devflamenbaum.grpc.api.GreetingResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.devflamenbaum.grpc.api.GreetingRequest,
      com.devflamenbaum.grpc.api.GreetingResponse> getGreetingMethod() {
    io.grpc.MethodDescriptor<com.devflamenbaum.grpc.api.GreetingRequest, com.devflamenbaum.grpc.api.GreetingResponse> getGreetingMethod;
      ...
      synchronized (GreetingServiceGrpc.class) {
        if ((getGreetingMethod = GreetingServiceGrpc.getGreetingMethod) == null) {
          GreetingServiceGrpc.getGreetingMethod = getGreetingMethod =
              io.grpc.MethodDescriptor.<com.devflamenbaum.grpc.api.GreetingRequest, com.devflamenbaum.grpc.api.GreetingResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "greeting"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.devflamenbaum.grpc.api.GreetingRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.devflamenbaum.grpc.api.GreetingResponse.getDefaultInstance()))
  ...
  public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void greeting(com.devflamenbaum.grpc.api.GreetingRequest request,
        io.grpc.stub.StreamObserver<com.devflamenbaum.grpc.api.GreetingResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.devflamenbaum.grpc.api.GreetingRequest,
                com.devflamenbaum.grpc.api.GreetingResponse>(
  ...
  public static final class GreetingServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreetingServiceBlockingStub> {
    ...
    /**
     */
    public com.devflamenbaum.grpc.api.GreetingResponse greeting(com.devflamenbaum.grpc.api.GreetingRequest request) {
  ...
  public static final class GreetingServiceFutureStub extends io.grpc.stub.AbstractFutureStub<GreetingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.devflamenbaum.grpc.api.GreetingResponse> greeting(
        com.devflamenbaum.grpc.api.GreetingRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREETING:
          serviceImpl.greeting((com.devflamenbaum.grpc.api.GreetingRequest) request,
              (io.grpc.stub.StreamObserver<com.devflamenbaum.grpc.api.GreetingResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreetingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.devflamenbaum.grpc.api.Greeting.getDescriptor();
    }
